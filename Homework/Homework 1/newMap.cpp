...
{
	m_map = new KeyAndValue[m_capacity];
}

Map::Map(int capacity) //Map constructor - can hold at most "capacity" key/value pairs.
...
Map::Map(const Map& src) //copy construct
...
Map& Map::operator=(const Map& src) //Assignment op
{
	delete[]m_map;
	m_size = src.m_size;
